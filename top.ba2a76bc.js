...
var test = function test() {
  ...
  var menuBtn = document.querySelectorAll('.header__menu');
  ...
  if (menuBtn) {
    for (var i = 0; i < menuBtn.length; i++) {
      menuBtn[i].addEventListener('click', function () {
        menu.classList.toggle('d-none');
        menuOpen.classList.toggle('d-none');
        menuSp === null || menuSp === void 0 ? void 0 : menuSp.classList.toggle('active');
      });
    }
  }
};
...
},{"./components/test":"js/top/components/test.ts"}]},{},["js/top/index.ts"], null)
//# sourceMappingURL=/top.ba2a76bc.js.map